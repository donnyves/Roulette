...
namespace Exercise_8C___Roulette____
{
    class Program
    {   static void DoWork()
        {
            Intro();
            Console.WriteLine("Please choose a number (1-10) that corresponds with game you want to play: ");
        ...
        {
            Console.WriteLine("Welcome to the Roulette Wheel Game");
        ...
        {
            //8. 6 Numbers: double rows, e.g., 1/2/3/4/5/6 or 22/23/24/25/26/27
            int temp = RouletteNum();
            Console.WriteLine("Please choose a number to place on the table");
            int num = Convert.ToInt32(Console.ReadLine());
